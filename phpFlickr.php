...
class phpFlickr {
    ...
    const API_SECRET = "Insert your API TOKEN here";
    const TOKEN_KEY = "Insert your TOKEN here";
    const TOKEN_SECRET = "Insert your TOKEN Secret here";
    ...
    public function __construct($die_on_error = false) {
       ...
       $this->cache->enableCache('fs', sys_get_temp_dir());
    }
